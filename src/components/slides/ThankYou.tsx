    ...
    <div className={`w-full h-full flex flex-col p-12 relative overflow-hidden bg-white transition-opacity duration-700 ${isActive ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-10">
            ...
            <div className={`text-center mb-12 transition-all duration-1000 transform ${isActive ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} animate-float`}>
                <div className="inline-block p-6 bg-olive-100 rounded-full mb-6 text-olive-800 shadow-sm hover:shadow-lg transition-shadow duration-300">
                     <HeartHandshake className="w-20 h-20 animate-pulse" strokeWidth={1.5} />
                </div>
                <h1 className="text-7xl font-bold text-olive-900 tracking-tight">Thank You</h1>
            </div>
            ...
            <div className={`flex flex-col items-center gap-2 mb-16 transition-all duration-1000 delay-300 transform ${isActive ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                 ...
                 <div className="flex items-center gap-3 text-xl text-olive-600">
